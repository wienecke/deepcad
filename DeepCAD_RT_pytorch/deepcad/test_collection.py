...
class testing_class():
    ...
    def read_modellist(self):
        ...
        test_last_model_only = 0 #WILSONLAB, CFRW, 240217, ALLOW TESTING ON ALL EPOCHS 
        if test_last_model_only:
            print("TESTING LAST MODEL ONLY, AS IN cabooster/DeepCAD-RT VERSION ON 231119")
            ...
            print("TESTING ALL MODELS, AS IN cabooster/DeepCAD-RT VERSION BEFORE 231119")
            model_path = self.pth_dir + '//' + self.denoise_model
